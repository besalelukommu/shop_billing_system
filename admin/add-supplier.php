...
if(isset($_POST["submit"])){
  ...
  $insert_supplier_query = mysql_query("INSERT INTO suppliers (name,mobile,email,gst,address,bank_details,status)
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body" style="height:615px;">
                  ...
                  <div class="p-12">
                    ...
                    <label for="msg"class="red center"><?php echo $msg; ?></label>
                ...
                <div class="card-body" style="height:615px;">
                  <div class="chart-pie">
                    <div class="row">
                      ...
                      <div class="col-md-7" style="color:#ef1c08;font-weight:bold;">SUPPLIER NAME</div>
                    ...
                    <?php
                      $all_supplier_query = mysql_query("SELECT * FROM suppliers") or die(mysqli_error());
