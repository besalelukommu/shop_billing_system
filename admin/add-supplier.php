...
if(isset($_POST["submit"])){
  ...
  $insert_supplier_query = mysql_query("INSERT INTO customer (name,mobile,email,gst,address,bank,status,type)
                                    values('".$name."','".$mobile."','$email','".$gst."','".$address."','".$bank."','Active','Supplier')") or die(mysqli_error());

  if($insert_supplier_query){
    $msg = "Successfully supplier added !";
  }else{
          ...
          <div class="col-xl-6 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Adding Supplier Details</h6>
                ...
                <div class="card-body" style="height:615px;">
                  ...
                  <div class="col-md-12 form-group center">
                   <input type="submit" class="btn btn-primary" value="Add Supplier" name="submit" />
                ...
                <div class="card-body" style="height:615px;">
                  <div class="chart-pie">
                    <div class="row">
                      ...
                      <div class="col-md-6" style="color:#ef1c08;font-weight:bold;">SUPPLIER NAME</div>
                    ...
                    <?php
                      $all_supplier_query = mysql_query("SELECT * FROM customer WHERE type = 'Supplier'") or die(mysqli_error());
