...
if(isset($_POST["submit"])){
  ...
  $insert_branch_query = mysql_query("INSERT INTO categories (category_name,status)
                                    values('".$category."','Active')") or die(mysql_error());
          ...
          <div class="col-xl-6 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Adding Categories Details</h6>
                ...
                <div class="card-body">
                  <div class="chart-pie">
                    <div class="row">
                      ...
                      <div class="col-md-6" style="color:#ef1c08;font-weight:bold;">CATEGORY NAME</div>
